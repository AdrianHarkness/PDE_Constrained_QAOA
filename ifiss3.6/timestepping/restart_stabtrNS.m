...
%   IFISS function: DJS; 21 September 2016 .. 16 September 2019
...
%%%%% accepted step 		   
 ...
 %--- correction    u  = resetflowbc(u,xy,bound,t);     % reset boundary value
    ...
    if tout==1, fprintf('--- Averaging step'), end
    else
%%%%%% regular step
       avstep=0;
       dt0 = dt;
...
gnst= -(B*u);
if tout==1,
fprintf('\n  %4i   %9.3e   %11.3e    %9.3e     %9.3e      %11.3e', n, dt, t,norm(rnst), norm(gnst),acc);
