function [DT,U,Udot,time] = restart_stabtrNSz(nonlin,qmethod,xy,ev,bound,A,B,C,G,AxB,...
                            initdata,tfinal,tol,nstar,tout,dpsi,restype)
%RESTART_STABTRNSZ legacy code | replaced by restart_stabtrNS
%   [DT,U,Udot,xtime] = restart_stabtrNSz(nonlin,qmethod,xy,ev,bound,A,B,C,G,AxB,...
